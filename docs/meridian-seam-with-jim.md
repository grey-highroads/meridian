...
**One word to keep straight: surface.** Added 2026-09-04. In Meridian a surface is a physical thing in the room that content plays on. The main wall behind the band. The two side screens. A building facade on a projection job. The tour's production designer supplies the list and Meridian stores it as given. In MadMapper, disguise, and tools like them, a surface is a mapped region on an output, which is Jim's side of the line. The two lists do not correspond and are not meant to. One wall in Meridian can be forty mapped regions in Jim's project. Meridian never names his, and nothing coming back from his side should use the word to mean his.
