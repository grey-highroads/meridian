...
Done when: you read the brain and find at least three things in it you did not know and would use in a creative conversation with that artist's team, each with its sources attached, and the system can represent every stage of the assignment start to finish without a screen.
