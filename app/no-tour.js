...
export function showNoTour(root, locationBar) {
  ...
  root.innerHTML = `<section class="m-empty-state m-empty-state--waiting" aria-labelledby="no-tour-heading">
      ...
      <div class="m-empty-state__body">
        <h2 id="no-tour-heading" class="m-section-heading">Start the project first</h2>
        <p class="m-copy m-copy--large">Once the project exists, its Scenes, reviews, and details will appear here.</p>
