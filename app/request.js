...
function intro() {
  return `<header class="m-form-page__intro"><span class="m-label">New Scene</span><h1 class="m-heading">What should this moment become?</h1><p class="m-copy m-copy--large">A sentence is enough. Keep it in your words and Higher Roads can develop it from there.</p><span class="m-state m-state--current">Against Direction V${String(view.tour.direction.version).padStart(2, "0")}</span></header>`;
}
