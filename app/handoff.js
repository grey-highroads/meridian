...
function renderNoBrief() {
  ...
  root.innerHTML = `<section class="m-empty-state m-empty-state--waiting" aria-labelledby="handoff-not-ready-heading">
      ...
      <div class="m-empty-state__body">
        ...
        <p class="m-copy m-copy--large">Production needs one exact Scene direction, its required elements, and the Project Direction version behind it. Finish that work in the Scene and send it to production from there.</p>
